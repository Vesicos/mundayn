...
const FaqItem = ({
  ...
  return <div className="mundayn-faq__item">
      <button className="mundayn-faq__question" onClick={() => setIsOpen(!isOpen)} aria-expanded={isOpen}>
        <div className="mundayn-faq__item-header">
          <span className="mundayn-faq__question-text">{question}</span>
          <span className={`mundayn-faq__icon ${isOpen ? 'mundayn-faq__icon--open' : ''}`}>
            +
          </span>
        </div>
        <div className="mundayn-faq__answer-preview">{preview}</div>
      </button>
        ...
        <div className="mundayn-container">
          <div className="mundayn-faq__card">
            ...
            <FaqItem 
              ...
              preview="Upgrade anytime. Your data stays. Your systems stay. You just unlock new features. Most (...)"
            ...
            <FaqItem 
              ...
              preview="That's exactly why DFY setup exists. You don't need to be technical. We build it, you use (...)"
            ...
            <FaqItem 
              ...
              preview="Yes. We have migration tools for most platforms. If you choose DFY setup, we handle the (...)"
            ...
            <FaqItem 
              ...
              preview="Complete technical implementation: (....)"
              answer={<>
            ...
            <FaqItem 
              ...
              preview="Yes. If you're Visionary Entrepreneur with 100K+ audience, ready for COO partnership, we (...)"
